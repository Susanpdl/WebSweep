...
const firebaseConfig = {
  ...
  authDomain: process.env.REACT_APP_FIREBASE_AUTH_DOMAIN || "datasweepr.firebaseapp.com",
  projectId: process.env.REACT_APP_FIREBASE_PROJECT_ID || "datasweepr",
  storageBucket: process.env.REACT_APP_FIREBASE_STORAGE_BUCKET || "datasweepr.firebasestorage.app",
